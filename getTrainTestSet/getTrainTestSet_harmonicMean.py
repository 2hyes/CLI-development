...
if __name__ == "__main__":
    ...
    pickle.dump(X_train, open('./dataset/dataset_harmonicMean/X_train.pkl','wb'))
    pickle.dump(X_test, open('./dataset/dataset_harmonicMean/X_test.pkl','wb'))
    pickle.dump(y_train, open('./dataset/dataset_harmonicMean/y_train.pkl','wb'))
    pickle.dump(y_test, open('./dataset/dataset_harmonicMean/y_test.pkl','wb'))
    pickle.dump(ccsi, open('./dataset/dataset_harmonicMean/ccsi.pkl','wb'))
    pickle.dump(predictors, open('./dataset/dataset_harmonicMean/predictors.pkl','wb'))
