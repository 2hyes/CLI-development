...
if __name__ == "__main__":
    ...
    pickle.dump(X_train, open('./dataset_median/X_train.pkl','wb'))
    pickle.dump(X_test, open('./dataset_median/X_test.pkl','wb'))
    pickle.dump(y_train, open('./dataset_median/y_train.pkl','wb'))
    pickle.dump(y_test, open('./dataset_median/y_test.pkl','wb'))
    pickle.dump(ccsi, open('./dataset_median/ccsi.pkl','wb'))
    pickle.dump(predictors, open('./dataset_median/predictors.pkl','wb'))
