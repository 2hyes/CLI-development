...
if __name__ == "__main__":
    ...
    pickle.dump(X_train, open('./dataset/dataset_min/X_train.pkl','wb'))
    pickle.dump(X_test, open('./dataset/dataset_min/X_test.pkl','wb'))
    pickle.dump(y_train, open('./dataset/dataset_min/y_train.pkl','wb'))
    pickle.dump(y_test, open('./dataset/dataset_min/y_test.pkl','wb'))
    pickle.dump(ccsi, open('./dataset/dataset_min/ccsi.pkl','wb'))
    pickle.dump(predictors, open('./dataset/dataset_min/predictors.pkl','wb'))
