...
if __name__ == "__main__":
    ...
    pickle.dump(X_train, open('./dataset/dataset_max/X_train.pkl', 'wb'))
    pickle.dump(X_test, open('./dataset/dataset_max/X_test.pkl', 'wb'))
    pickle.dump(y_train, open('./dataset/dataset_max/y_train.pkl', 'wb'))
    pickle.dump(y_test, open('./dataset/dataset_max/y_test.pkl', 'wb'))
    pickle.dump(ccsi, open('./dataset/dataset_max/ccsi.pkl', 'wb'))
    pickle.dump(predictors, open('./dataset/dataset_max/predictors.pkl', 'wb'))
